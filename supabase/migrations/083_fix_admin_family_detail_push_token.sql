-- 083: get_admin_family_detail() still referenced family_members.push_token,
-- which 076_push_tokens_per_platform.sql split into push_token_ios/android/web
-- and dropped. Broke the admin dashboard's family detail view.
  ...
  SELECT jsonb_build_object(
    ...
    'members', (
      SELECT jsonb_agg(jsonb_build_object(
        ...
        'email',        u.email,
        'push_token',   (fm.push_token_ios IS NOT NULL OR fm.push_token_android IS NOT NULL OR fm.push_token_web IS NOT NULL)
