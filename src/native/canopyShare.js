...
// sessionStorage key used to hand a received share payload from AppLayout.jsx
// (where the native listener/pull lives) to AddFromSharePage.jsx (where it's
// consumed) across a navigation. Defined here, not in the page component, so
// importing it doesn't defeat AddFromSharePage's lazy-loading in App.jsx.
