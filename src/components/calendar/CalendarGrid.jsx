...
export default function CalendarGrid({ calendarDays, selectedDateStr, onSelectDay, selectingEndDate, eventDates, termDays, birthdayDates, morningNeededDates }) {
  return (
    <div>
      {/* Day-of-week headers */}
      ...
      <div className="grid grid-cols-7 gap-1">
        {calendarDays.map((day) => (
          <DayCell
            ...
            morningNeeded={morningNeededDates?.has(day.dateStr) ?? false}
          />
        ))}
      </div>
    </div>
