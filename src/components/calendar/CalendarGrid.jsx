...
export default function CalendarGrid({ calendarDays, selectedDateStr, onSelectDay, selectingEndDate, eventDates, termDays, birthdayDates, peDates, peKitLabel }) {
  return (
    <div>
      {/* Day-of-week headers */}
