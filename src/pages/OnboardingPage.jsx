    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-orange-50 flex flex-col items-center justify-center px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-4">
          ...
          {step === 'create' && (
            <>
              <button onClick={() => setStep('choose')} className="text-sm text-blue-600 flex items-center gap-1 mb-1">
                ← Back
              </button>
          ...
          {step === 'join' && (
            <>
              ...
              <input
                ...
                className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm font-mono tracking-widest focus:outline-none focus:ring-2 focus:ring-blue-500"
                maxLength={8}
              />
              {error && <p className="text-sm text-red-600">{error}</p>}
