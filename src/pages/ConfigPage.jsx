...
export default function ConfigPage() {
  ...
  return (
    <div className="px-4 py-5 space-y-2">
      ...
      {/* ── Parenting Schedule ── */}
      <GroupLabel>Parenting Schedule</GroupLabel>
      <GroupCard>
      ...
      {familyEmail && (
        <>
          <GroupLabel>FamilyFeed</GroupLabel>
          <GroupCard>
            <div className="px-4 py-3 space-y-3">
      ...
      {/* ── Calendar sync ── */}
      <GroupLabel>Calendar Sync</GroupLabel>
      <CalendarSyncSection />
...
function GroupLabel({ children }) {
  return (
    <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide px-1 pt-4 pb-1">
      {children}
    </p>
  )
}
